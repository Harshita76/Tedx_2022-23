          ...
          <div className="footer-col23">
            <div className="footer-col2">
              ...
              <div className="footer-social">
                <a
                  href="https://www.facebook.com/search/top?q=tedxbitshyderabad"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/company/tedxbitshyderabad/mycompany/"
                  target="_blank"
                  rel="noopener noreferrer"
